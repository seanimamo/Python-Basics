my_variable = 'hello'
my_list_variable = ['hello', 'hi', 'nice to meet you'] #mutable array
my_tuple_variable = ('hello', 'hi', 'nice to meet you') #tuples are immutable
my_set_variable = {'hello', 'hi', 'nice to meet you'} #sets are unique and unordered
